...
namespace RmindApp
{
    public partial class SearchForm : Form
    {
        ...
        private void chkMed2_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void chkBeauty2_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void chkOthers2_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void chkFNB2_CheckedChanged(object sender, EventArgs e)
        {
        }
